...
backup_dir='/home/bitrix/backup/db/daily/'
#storage_dir='/mnt/backup/db/daily/'
#rsync_output='/home/bitrix/backup/rsync_daily.log'
...
find $backup_dir -name "*.sql.gz" -type f -mtime +5 -exec rm {} \; > /dev/null 2>&1
